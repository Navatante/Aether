...
import org.jonatancarbonellmartinez.presentation.viewmodel.xPersonXPanelXPresenter;
...
public class xPersonXPanelXView extends JPanel implements xView, xPanelView {
    private xPersonXPanelXPresenter presenter;
    ...
    public xPersonXPanelXView() {
        this.presenter = new xPersonXPanelXPresenter(this);
        this.initializeUI();
        updatePanel();
        setVisible(true);
    }
    ...
    public void configureComponents() {
        personTitleLabel.setFont(xPanelView.ENTITY_TITLE_LABEL_FONT);
    ...
    xView.addComponentsToPanel(insideTopPanelLeft, personTitleLabel);
    xView.addComponentsToPanel(insideTopPanelRight, searchField, togglePersonState);
