...
public interface xView {
    ...
    static JComboBox<String> createFixedComboBox(String[] values, String placeholder) {
        ...
        comboBox.setRenderer(xView.createComboBoxRenderer(placeholder));
        comboBox.addActionListener(e -> xView.updateFixedComboBoxAppearance(comboBox, placeholder));
        return comboBox;
    }
    ...
    static JComboBox<Entity> createDynamicComboBox(Vector<Entity> entityList, String placeholder) {
        ...
        comboBox.setRenderer(xView.createComboBoxRenderer(placeholder)); // Configura el renderer para el placeholder
        comboBox.addActionListener(e -> xView.updateDynamicComboBoxAppearance(comboBox, placeholder)); // Actualiza la apariencia
        return comboBox;
    }
