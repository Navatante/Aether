...
public class PilotCrewCardPanel extends JPanel implements xView, CrewCardPanel {

    private xRegisterFlightXPresenterX presenter;
    xRegisterFlightXDialogXView registerFlightDialogView;
    ...
    public PilotCrewCardPanel(xRegisterFlightXDialogXView registerFlightDialogView, xRegisterFlightXPresenterX registerFlightPresenter, String pilotPlaceHolder) {
    ...
    public void createComponents() {
        pilotBox = xView.createDynamicComboBox(new Vector<>(presenter.getAllPilotsVector()),pilotPlaceHolder);
        ...
        iftHourField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"I", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
        hdmsHourField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"H", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
        instructorHourField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"I", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
        dayFormacionesHourField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"D", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
        gvnFormacionesHourField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"G", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
        ...
        precisionField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"P", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        noPrecisionField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"N", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);

        sarLabel = new JLabel("SAR");
        tdLabel = new JLabel("T/D");
        tdField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"T", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        srchPattLabel = new JLabel("Search Pattern");
        srchPattField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"S", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        ...
        tierraDayField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"D", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        tierraNightField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"N", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        tierraGvnField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"G", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        monoDayField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"D", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        monoNightField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"N", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        monoGvnField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"G", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        multiDayField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"D", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        multiNightField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"N", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        multiGvnField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"G", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        carrierDayField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"D", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        carrierNightField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"N", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
        carrierGvnField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"G", xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER, xView.DYNAMIC_FINAL_NON_NEGATIVE_OR_ZERO_INTEGER);
    }
    ...
    public void configureComponents() {
        xView.setInitialComboBoxLook(pilotBox);
        xView.setPreferredSizeForComponents(CrewCardPanel.PERSON_BOX_DIMENSION, pilotBox);
        xView.setPreferredSizeForComponents(CrewCardPanel.HOUR_FIELD_DIMENSION, dayHourField, nightHourField, gvnHourField, iftHourField, hdmsHourField, instructorHourField, dayFormacionesHourField, gvnFormacionesHourField,
        ...
        xView.setHorizontalAlignmentToFields(dayHourField, nightHourField, gvnHourField, iftHourField, hdmsHourField, instructorHourField, dayFormacionesHourField, gvnFormacionesHourField,
                                            precisionField, noPrecisionField, tdField, srchPattField,
                                            monoDayField, monoNightField, monoGvnField, multiDayField, multiNightField, multiGvnField,  tierraDayField, tierraNightField, tierraGvnField, carrierDayField, carrierNightField, carrierGvnField);
    ...
    public void assemblePanels() {
        ...
        xView.addComponentsToPanel(hoursDetailPanel, vueloPanel, instrumentosPanel, hdmsPanel, instructorPanel, formacionesPanel);
        ...
        xView.addComponentsToPanel(appsDetailPanel, precisionPanel, noPrecisionPanel);
        ...
        xView.addComponentsToPanel(landingsDetailPanel, tierraPanel,monospotPanel, multispotPanel, carrierPanel);
    ...
    public void assembleComponents() {
        ...
        xView.addComponentsToPanel(instrumentosDataPanel, iftHourField);
        ...
        xView.addComponentsToPanel(formacionesDataPanel, dayFormacionesHourField, gvnFormacionesHourField);
        ...
        xView.addComponentsToPanel(tierraDataPanel, tierraDayField, tierraNightField, tierraGvnField);
        monospotTituloPanel.add(monospotLabel);
        xView.addComponentsToPanel(monospotDataPanel, monoDayField, monoNightField, monoGvnField);
        multispotTituloPanel.add(multispotLabel);
        xView.addComponentsToPanel(multispotDataPanel, multiDayField, multiNightField, multiGvnField);
        carrierTituloPanel.add(carrierLabel);
        xView.addComponentsToPanel(carrierDataPanel, carrierDayField, carrierNightField, carrierGvnField);
