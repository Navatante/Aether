...
public interface xDialogView { // TODO hacer esto mejor, porque hay algunos que no utilizo en algunas views. quiza crear una interfaz distinta por tipo de Dialog, ejemplo: RegisterDialogView, AddDialogView, EditDialogView.
