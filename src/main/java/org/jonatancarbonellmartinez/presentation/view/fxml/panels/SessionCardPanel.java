...
public class SessionCardPanel extends JPanel implements xView {
    ...
    public SessionCardPanel(xRegisterFlightXDialogXView registerFlightDialogView, xRegisterFlightXPresenterX registerFlightPresenter) {
    ...
    public void createComponents() {
        ...
        personBox = xView.createDynamicComboBox(new Vector<>(presenter.getAllPersonsVector()),"CREW");
        extraPersonBoxesDeque.add(personBox);

        sessionBox = xView.createDynamicComboBox(new Vector<>(presenter.getAllSessionsVector()), "Papeleta");
    ...
    public void configureComponents() {
        xView.setInitialComboBoxLook(personBox);
        xView.setInitialComboBoxLook(sessionBox);
    ...
    public void addExtraPersonBox() {
        if(extraPersonBoxesDeque.size()<10) { // I limit the addition of personBoxes to 10
            JComboBox personBox = xView.createDynamicComboBox(new Vector<>(presenter.getAllPersonsVector()),"CREW");
            xView.setInitialComboBoxLook(personBox);
            personBox.setMaximumSize(CrewCardPanel.PERSON_BOX_DIMENSION);
            personBox.setAlignmentX(Component.CENTER_ALIGNMENT);
            personBoxesPanel.add(personBox);
    ...
    public void addExtraSessionBox() {
        if(extraSessionBoxesDeque.size()<6) { // I limit the addition of personBoxes to 6
            JComboBox sessionBox = xView.createDynamicComboBox(new Vector<>(presenter.getAllSessionsVector()),"Papeleta");
            xView.setInitialComboBoxLook(sessionBox);
            sessionBox.setMaximumSize(CrewCardPanel.SESSION_BOX_DIMENSION);
            sessionBox.setAlignmentX(Component.CENTER_ALIGNMENT);
            sessionBoxesPanel.add(sessionBox);
