...
import org.jonatancarbonellmartinez.presentation.view.fxml.panels.*;
...
public class xRegisterFlightXDialogXView extends JDialog implements xView, xDialogView {
    ...
    public xRegisterFlightXDialogXView(xMainXView mainView, Point locationRelativeTo) {
        super(mainView, "Registrar vuelo",true);
        this.mainView = mainView;
        this.presenter = new xRegisterFlightXPresenterX(this, mainView.getPresenter());
        this.initializeUI();
    ...
    public void createComponents() {
        ...
        heloBox = xView.createDynamicComboBox(new Vector<>(presenter.getHeloList()),"Helicóptero");
        eventBox = xView.createDynamicComboBox(new Vector<>(presenter.getEventList()),"Evento");
        totalHoursField = new JonJTextField(xView.INPUT_FONT, xView.PLACEHOLDER_FONT,"Horas totales", xView.DYNAMIC_HOUR, xView.FINAL_HOUR);
    ...
    public void configurePanels() {
        ...
        xView.setMouseListenerToPanel(hoursAppsLandingsProjectilesScrollPanel, horasAppsTomasProjectilesPopupMenu);
        xView.setMouseListenerToPanel(cupoHourScrollPanel, horasCupoPopupMenu);
        xView.setMouseListenerToPanel(passengerScrollPanel, passengerPopupMenu);
    ...
    public void configureComponents() {
        ...
        xView.setInitialComboBoxLook(heloBox,eventBox);
        xView.setPreferredSizeForComponents(new Dimension(eventBox.getPreferredSize().width+100, 25), eventBox);
        xView.setPreferredSizeForComponents(new Dimension(155,24),dateTimeSpinner,heloBox, totalHoursField);
    ...
    public void assembleComponents() {
        xView.addComponentsToPanel(vueloPanel,dateTimeSpinner, heloBox, eventBox, totalHoursField);
