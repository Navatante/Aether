...
import org.jonatancarbonellmartinez.presentation.viewmodel.xRecentFlightsXPanelXPresenter;
...
public class xRecentFlightsXPanelXView extends JPanel implements xView, xPanelView {
    private xRecentFlightsXPanelXPresenter presenter;
    ...
    public xRecentFlightsXPanelXView() {
        this.presenter = new xRecentFlightsXPanelXPresenter(this);
        this.initializeUI();
        updatePanel();
        setVisible(true);
    }
    ...
    public void configureComponents() {
        xView.setFontToLabels(xPanelView.ENTITY_TITLE_LABEL_FONT, lastFlightsTitleLabel, flightDetailsTitleLabel);
        xView.setFontToLabels(xPanelView.ENTITY_SUBTITLE_LABEL_FONT, crewHoursDetailTitleLabel, sessionDetailTitleLabel, landingTitleLabel, instrumentalAppsTitleLabel, sarTitleLabel, projectilesTitleLabel, cupoTitleLabel, passengersTitleLabel);
    ...
    public void assemblePanels() {
        ...
        xView.addComponentsToPanel(bottomPanelCenterTop, crewHoursDetailPanel, sessionDetailPanel);
        xView.addComponentsToPanel(bottomPanelCenterBottom, landingPanel, instrumentalAppsPanel, sarPanel, projectilesPanel, cupoPanel, passengersPanel);
    ...
    public void assembleComponents() {
        xView.addComponentsToPanel(insideTopPanelTopLeft, lastFlightsTitleLabel);
        xView.addComponentsToPanel(insideTopPanelTopRight, searchField);
        xView.addComponentsToPanel(centerPanelTop, flightDetailsTitleLabel);
        xView.addComponentsToPanel(crewHoursDetailPanelTop, crewHoursDetailTitleLabel);
        xView.addComponentsToPanel(crewHoursDetailPanelBottom, crewHoursDetailScrollPane);
        xView.addComponentsToPanel(sessionDetailPanelTop, sessionDetailTitleLabel);
        xView.addComponentsToPanel(sessionDetailPanelBottom, sessionDetailScrollPane);
        xView.addComponentsToPanel(landingPanelTop, landingTitleLabel);
        xView.addComponentsToPanel(landingPanelBottom, landingScrollPane);
        xView.addComponentsToPanel(instrumentalAppsPanelTop, instrumentalAppsTitleLabel);
        xView.addComponentsToPanel(instrumentalAppsPanelBottom, instrumentalAppsScrollPane);
        xView.addComponentsToPanel(sarPanelTop, sarTitleLabel);
        xView.addComponentsToPanel(sarPanelBottom, sarScrollPane);
        xView.addComponentsToPanel(projectilesPanelTop, projectilesTitleLabel);
        xView.addComponentsToPanel(projectilesPanelBottom, projectilesScrollPane);
        xView.addComponentsToPanel(cupoPanelTop, cupoTitleLabel);
        xView.addComponentsToPanel(cupoPanelBottom, cupoScrollPane);
        xView.addComponentsToPanel(passengersPanelTop, passengersTitleLabel);
        xView.addComponentsToPanel(passengersPanelBottom, passengersScrollPane);
    }
        ...
        public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
            ...
            if (isSelected) {
                ...
                if (value instanceof Double && ((Double) value) == 0.0) {
                    cell.setForeground(xView.tableBackgroundColor); // Gray color for 0.0 values
                } else {
