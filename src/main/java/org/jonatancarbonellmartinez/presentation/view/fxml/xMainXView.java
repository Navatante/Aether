...
import org.jonatancarbonellmartinez.presentation.viewmodel.xMainXPresenter;
...
public class xMainXView extends JFrame implements xView {

    private xMainXPresenter presenter;
    ...
    public xMainXView() {
        presenter = new xMainXPresenter(this);
        this.initializeUI();
        setVisible(true);
    }
    ...
    public void assembleComponents() {
        ...
        xView.addMenusToMenu(menuBar, registrarMenu, anadirMenu, anadirMenu, editarMenu, generarMenu);
        xView.addMenusToMenu(registrarMenu,registrarVueloMenuItem, registrarCombustibleMenuItem, registrarCalificacionMenuItem);
        xView.addMenusToMenu(anadirMenu,anadirPersonalMenuItem,anadirEventoMenuItem);
        xView.addMenusToMenu(editarMenu, editarPersonalMenuItem, editarEventoMenuItem);
        xView.addMenusToMenu(generarMenu, docSemanalMenuItem, docMensualMenuItem);

        xView.addComponentsToPanel(topLeftPanel, botonPrincipal, botonPilotos, botonDotaciones, botonRecentFlights);
        xView.addComponentsToPanel(bottomLeftPanel, botonPersonal, botonEventos, botonSesiones, botonHelos);
    }
    ...
    public xMainXPresenter getPresenter() {
        return presenter;
    }
