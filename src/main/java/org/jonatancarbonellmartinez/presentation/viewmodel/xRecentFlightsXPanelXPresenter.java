...
public class xRecentFlightsXPanelXPresenter implements xPresenter, xPanelPresenter {

    private final xRecentFlightsXPanelXView view;

    private int selectedVueloId;

    public xRecentFlightsXPanelXPresenter(xRecentFlightsXPanelXView view) {
        this.view = view;
    }
